...
create table "foruminfo" ("userID" VARCHAR NOT NULL PRIMARY KEY,"title" VARCHAR NOT NULL,"detail" VARCHAR ,"imagepost" VARCHAR,"vdopost" VARCHAR,"date" INTEGER );
create table "comment" ("userID" VARCHAR NOT NULL,"idcomment" VARCHAR NOT NULL,"detail" VARCHAR );
