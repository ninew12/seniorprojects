...
create table "foruminfo" ("id" VARCHAR NOT NULL PRIMARY KEY ,"title" VARCHAR NOT NULL,"detail" VARCHAR ,"imagepost" VARCHAR,"vdopost" VARCHAR,"date" INTEGER );
create table "comment" ("id" VARCHAR NOT NULL PRIMARY KEY,"detail" VARCHAR );
