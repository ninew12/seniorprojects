...
create table "comment" ("id" VARCHAR NOT NULL PRIMARY KEY, "userID" VARCHAR NOT NULL, "detail" VARCHAR, "artworkid" VARCHAR NOT NULL );
create table "answer" ("id" VARCHAR NOT NULL PRIMARY KEY, "userID" VARCHAR NOT NULL, "detail" VARCHAR, "forumid" VARCHAR NOT NULL );
...
create table "collection" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY , "artworkid" VARCHAR NOT NULL  , "userID" VARCHAR NOT NULL);
create table "follow" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY ,"fid" VARCHAR NOT NULL , "userID" VARCHAR NOT NULL );
# --- !Downs
