                ...
                <nav class="collapse navbar-collapse">
                    ...
                    <a href=""""),_display_(/*53.31*/routes/*53.37*/.ApplicationController.index),format.raw/*53.65*/("""" class="dropdown-toggle" data-toggle="dropdown" >Blend</a>
                      ...
                      """)))}/*89.24*/.getOrElse/*89.34*/ {_display_(Seq[Any](format.raw/*89.36*/("""
                          """),format.raw/*90.27*/("""<li><a href=""""),_display_(/*90.41*/routes/*90.47*/.ApplicationController.signIn),format.raw/*90.76*/("""">"""),_display_(/*90.79*/Messages("sign.in")),format.raw/*90.98*/("""</a></li>
                          <li><a href=""""),_display_(/*91.41*/routes/*91.47*/.ApplicationController.signUp),format.raw/*91.76*/("""">"""),_display_(/*91.79*/Messages("sign.up")),format.raw/*91.98*/("""</a></li>
                      """)))}),format.raw/*92.24*/("""
                    """),format.raw/*93.21*/("""</ul>
                </nav>
            </div>
